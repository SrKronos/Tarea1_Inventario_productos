 ...
 * @author Asus.com
 */
public class rowProductos extends javax.swing.JPanel {
...
String regex = "^\\d+[" + decimalSeparator + "]?\\d{0.2}$";
    ...
    public rowProductos(Producto p){
       initComponents();    
        p1 = p;
    ...
    private void initComponents() {
        ...
        btnGuardarProducto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pack_save_32.png"))); // NOI18N
        btnGuardarProducto.setToolTipText("Guardar los Cambios");
        ...
        campo_cantidad.setToolTipText("Stock");
    ...
    private void btnGuardarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarProductoActionPerformed
        if (validarCampos()) {
            this.setValores();
            Respuesta respuesta = cp.GuardarProducto(p1);
            p1 = respuesta.getP1();
            getValores();
